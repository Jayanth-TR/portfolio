  ...
  section.innerHTML = `
    <div class="container">
      ...
      <div class="contact-channels reveal">
        ...
        <!-- GitHub -->
        <a href="https://github.com/" target="_blank" rel="noopener noreferrer" class="contact-channel-card" id="contact-github" aria-label="GitHub Profile">
          <div class="contact-channel-card__icon">
        ...
        <!-- LinkedIn -->
        <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" class="contact-channel-card" id="contact-linkedin" aria-label="LinkedIn Profile">
          <div class="contact-channel-card__icon">
            <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
